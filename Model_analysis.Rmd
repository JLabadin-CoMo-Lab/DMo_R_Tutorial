...
## Compairing a model's prediction with data
We will use our model to simulate transmission of influenza A/H1N1. The flu data we use in this tutorial is retrieve from ```epimdr``` packages in R.  
